...
const OrdemAberta = (props) => {
    ...
    const atualizarConferido = async (e) => {
        await api.put(`entrega_produto/dto/armazenado/${exibir.idEntregaProduto}`)
        alert("Atualizado com sucesso")
    }

    const atualizarSeparado = async (e) => {
        await api.put(`entrega_produto/dto/separado/${exibir.idEntregaProduto}`)
        alert("Atualizado com sucesso")
    }
            ...
            return (
                <>
                    ...
                    <div className="buttonCardOrdem">
                        ...
                        <button className="buttonOrangeActionAtualizar" alt="Botão de atualizar o ordem" onClick={atualizarConferido}>Confirmar Conferência<GoListUnordered /></button>
                        <button className="buttonOrangeActionAtualizar" alt="Botão de atualizar o ordem" onClick={atualizarSeparado}>Confirmar Separação<GoListUnordered /></button>
                    </div>
                </>
            )
        } else {
