...
import OrdemEntrega from "../../components/EstoquistaComponents/OrdemEntrega";
import MapaCarga from "../../components/EstoquistaComponents/MapaCarga";
    ...
    return (
        <div className="theme" data-theme={theme} >
            <header id="header" className="theme-toggle">
                <h2 className="accessLogado"><FaBoxOpen /> Estoquista</h2>
